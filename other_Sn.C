void other_Sn()
{
    ...
    Double_t fermi_r{5.6469};
    Double_t fermi_w{5.5558};

    Double_t sn1_fermi_r{5.6444};
    Double_t sn1_fermi_w{5.5531};

    Double_t sn2_fermi_r{5.6427};
    Double_t sn2_fermi_w{5.5511};

    Double_t sn5_fermi_r{5.6381};
    Double_t sn5_fermi_w{5.5446};

    /*Double_t sn10_fermi_r{5.7658};
    Double_t sn10_fermi_w{5.7014};*/
    ...
    TGraph *sn1 = new TGraph("kagome_Sn_1_other.dat");
    ...
    TGraph *sn2 = new TGraph("kagome_Sn_2_other.dat");
    ...
    TGraph *sn5 = new TGraph("kagome_Sn_5_other.dat");
    ...
    /*TGraph *sn10 = new TGraph("kagome_Sn_10_other.dat");
    ...
    g->SetLineColor(13);
    sn1->SetLineColor(kGreen - 4);
    sn2->SetLineColor(kGreen +1);
    sn5->SetLineColor(kGreen + 3);
    //sn10->SetLineColor(kGreen + 3);

    g->SetMarkerColor(13);
    sn1->SetMarkerColor(kGreen - 4);
    sn2->SetMarkerColor(kGreen + 1);
    sn5->SetMarkerColor(kGreen + 3);
    ...
    mg->GetHistogram()->SetTitle("#font[132]{Drogaggio con Sn dell'atomo di Sb sullo stesso piano dei 3 V}");
