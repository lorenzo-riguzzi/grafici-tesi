...
void kagome_cool_bands()
{
    ...
    Double_t sn1_fermi_r{5.6429};
    Double_t sn1_fermi_w{5.5430};

    Double_t sn2_fermi_r{5.6378};
    Double_t sn2_fermi_w{5.5290};

    Double_t sn5_fermi_r{5.6203};
    Double_t sn5_fermi_w{5.4871};

    Double_t sn10_fermi_r{5.5755};
    Double_t sn10_fermi_w{5.4080};

    Double_t te1_fermi_r{5.6453};
    Double_t te1_fermi_w{5.5620};

    Double_t te2_fermi_r{5.6435};
    Double_t te2_fermi_w{5.5645};

    Double_t te5_fermi_r{5.6490};
    Double_t te5_fermi_w{5.5717};

    Double_t te10_fermi_r{5.6606};
    Double_t te10_fermi_w{5.5842};

    // INSERIRE NUMERI DI ELETTRONI
    Double_t n_el{49.0000};

    Double_t n_el_sn_1{48.9600};
    Double_t n_el_sn_2{48.9200};
    Double_t n_el_sn_5{48.8000};
    Double_t n_el_sn_10{48.6000};

    Double_t n_el_te_1{49.0400};
    Double_t n_el_te_2{49.0800};
    Double_t n_el_te_5{49.2000};
    Double_t n_el_te_10{49.4000};
    ...
    TGraph *sn1 = new TGraph("kagome_Sn_1.dat");
    ...
    TGraph *sn2 = new TGraph("kagome_Sn_2.dat");
    ...
    sn2->GetXaxis()->SetRangeUser(0, A2);
    // sn2->GetYaxis()->SetTitle("Energy (eV)");
    // sn2->SetTitle("Drogaggio al 2% di Sn");

    TGraph *sn5 = new TGraph("kagome_Sn_5.dat");
    ...
    sn5->GetXaxis()->SetRangeUser(0, A2);
    // sn5->GetYaxis()->SetTitle("Energy (eV)");
    // sn5->SetTitle("Drogaggio al 5% di Sn");

    TGraph *sn10 = new TGraph("kagome_Sn_10.dat");
    ...
    sn10->GetXaxis()->SetRangeUser(0, A2);
    // sn10->GetYaxis()->SetTitle("Energy (eV)");
    // sn10->SetTitle("Drogaggio al 10% di Sn");

    TGraph *Te1 = new TGraph("kagome_Te_1.dat");
    ...
    //Te1->GetXaxis()->SetRangeUser(0, A2);
    // Te1->GetYaxis()->SetTitle("Energy (eV)");
    // Te1->SetTitle("Drogaggio all'1% di Te");

    TGraph *Te2 = new TGraph("kagome_Te_2.dat");
    ...
    //Te2->GetXaxis()->SetRangeUser(0, A2);
    // Te2->GetYaxis()->SetTitle("Energy (eV)");
    // Te2->SetTitle("Drogaggio al 2% di Te");

    TGraph *Te5 = new TGraph("kagome_Te_5.dat");
    ...
    //Te5->GetXaxis()->SetRangeUser(0, A2);
    // Te5->GetYaxis()->SetTitle("Energy (eV)");
    // Te5->SetTitle("Drogaggio al 5% di Te");

    TGraph *Te10 = new TGraph("kagome_Te_10.dat");
    ...
    //Te10->GetXaxis()->SetRangeUser(0, A2);
    ...
    Te1->GetXaxis()->SetRangeUser(0, A2_Te_1);
    Te5->GetXaxis()->SetRangeUser(0, A2_Te_2);
    Te2->GetXaxis()->SetRangeUser(0, A2_Te_5);
    Te10->GetXaxis()->SetRangeUser(0, A2_Te_10);
    ...
    mg->GetHistogram()->SetTitle("#font[132]{Bande energetiche di CsV_{3}Sb_{5} a vari livelli di drogaggio}");
    mg->GetYaxis()->SetLabelFont(132);
    mg->GetXaxis()->SetDecimals(kTRUE);
    mg->GetYaxis()->SetDecimals(kTRUE);
    ...
    Double_t L = g->GetPointX(5 * n_points);
    Double_t H = g->GetPointX(6 * n_points);
    Double_t A2 = g->GetPointX(7 * n_points) - 0.02;*/
    ...
    cout << "Differenza di elettroni attesa per i livelli di drogaggio: " << '\n';
    cout << '\n';

    Double_t delta_e_sn_1_th = 4 * 5 * 0.99 + 4 * 4 * 0.01 - 4 * 5 * 1;
    Double_t delta_e_sn_2_th = 4 * 5 * 0.98 + 4 * 4 * 0.02 - 4 * 5 * 1;
    Double_t delta_e_sn_5_th = 4 * 5 * 0.95 + 4 * 4 * 0.05 - 4 * 5 * 1;
    Double_t delta_e_sn_10_th = 4 * 5 * 0.90 + 4 * 4 * 0.10 - 4 * 5 * 1;

    Double_t delta_e_te_1_th = 4 * 5 * 0.99 + 4 * 6 * 0.01 - 4 * 5 * 1;
    Double_t delta_e_te_2_th = 4 * 5 * 0.98 + 4 * 6 * 0.02 - 4 * 5 * 1;
    Double_t delta_e_te_5_th = 4 * 5 * 0.95 + 4 * 6 * 0.05 - 4 * 5 * 1;
    Double_t delta_e_te_10_th = 4 * 5 * 0.90 + 4 * 6 * 0.10 - 4 * 5 * 1;

    cout << "1% di Sn: " << delta_e_sn_1_th << '\n';
    cout << "2% di Sn: " << delta_e_sn_2_th << '\n';
    cout << "5% di Sn: " << delta_e_sn_5_th << '\n';
    cout << "10% di Sn: " << delta_e_sn_10_th << '\n';
    cout << '\n';

    cout << "1% di Te: " << delta_e_te_1_th << '\n';
    cout << "2% di Te: " << delta_e_te_2_th << '\n';
    cout << "5% di Te: " << delta_e_te_5_th << '\n';
    cout << "10% di Te: " << delta_e_te_10_th << '\n';
    cout << '\n';

    Double_t delta_sn_th[4] = {delta_e_sn_1_th, delta_e_sn_2_th, delta_e_sn_5_th, delta_e_sn_10_th};
    Double_t delta_te_th[4] = {delta_e_te_1_th, delta_e_te_2_th, delta_e_te_5_th, delta_e_te_10_th};
    Double_t delta_sn_exp[4] = {n_el_sn_1 - n_el, n_el_sn_2 - n_el, n_el_sn_5 - n_el, n_el_sn_10 - n_el};
    Double_t delta_te_exp[4] = {n_el_te_1 - n_el, n_el_te_2 - n_el, n_el_te_5 - n_el, n_el_te_10 - n_el};
    string percent[4] = {"1%", "2%", "5%", "10%"};

    cout << "Differenza di cariche osservata:" << '\n';
    cout << '\n';

    for (Int_t i{}; i < 4; i++)
    {
        cout << percent[i] << "di Sn " << delta_sn_exp[i] << '\n';
    }
    ...
    for (Int_t i{}; i < 4; i++)
    {
        cout << percent[i] << "di Te " << delta_te_exp[i] << '\n';
    }
}